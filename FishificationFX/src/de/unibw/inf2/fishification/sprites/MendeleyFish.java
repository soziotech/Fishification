...
/**
 * Creates Mendeley fish sprite.
 *
 * @author Martin Burkhard
 */
class MendeleyFish extends Sprite {

    public MendeleyFish(AbstractWorld world) {
        super("Mendeley_Fish_Animation.png", world, CategoryType.MENDELEY, 320, 160, 1, 1);
    }
}
