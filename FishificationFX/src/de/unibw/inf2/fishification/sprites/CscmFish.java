...
/**
 * Creates CSCM fish sprite.
 *
 * @author Martin Burkhard
 */
class CscmFish extends Sprite {

    public CscmFish(AbstractWorld world) {
        super("CSCM_Fish_Animation.png", world, CategoryType.CSCM, 320, 160, 1, 1);
    }
}
