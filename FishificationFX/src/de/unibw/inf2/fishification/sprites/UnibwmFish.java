...
/**
 * Creates UniBwM fish sprite.
 *
 * @author Martin Burkhard
 */
class UnibwmFish extends Sprite {

    public UnibwmFish(AbstractWorld world) {
        super("UniBwM_Fish_Animation.png", world, CategoryType.UNIBWM, 320, 160, 1, 1);
    }
}
