...
/**
 * Creates Red fish sprite.
 *
 * @author Martin Burkhard
 */
class RedFish extends Sprite {

    public RedFish(AbstractWorld world) {
        super("Red_Fish_Animation.png", world, CategoryType.RED, 320, 160, 7, 7, true);
    }
}
