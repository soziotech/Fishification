...
/**
 * Creates Seahorse fish sprite.
 *
 * @author Martin Burkhard
 */
class Seahorse extends Sprite {

    public Seahorse(AbstractWorld world) {
        super("Seahorse_Animation.png", world, CategoryType.SEAHORSE, 320, 160, 1, 1);
    }
}
