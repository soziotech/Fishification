...
/**
 * Creates Glasses fish sprite.
 *
 * @author Martin Burkhard
 */
class GlassesFish extends Sprite {

    public GlassesFish(AbstractWorld world) {
        super("Glasses_Fish_Animation.png", world, CategoryType.GLASSES, 320, 160, 1, 1);
    }
}
