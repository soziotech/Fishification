...
/**
 * Creates Studiendekan fish sprite.
 *
 * @author Martin Burkhard
 */
class StudiendekanFish extends Sprite {

    public StudiendekanFish(AbstractWorld world) {
        super("Studiendekan_Fish_Animation.png", world, CategoryType.STUDIENDEKAN, 320, 160, 12, 3);
    }
}
