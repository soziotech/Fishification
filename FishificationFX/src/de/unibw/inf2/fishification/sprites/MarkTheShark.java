...
/**
 * Creates Mark the Shark sprite.
 *
 * @author Martin Burkhard
 */
class MarkTheShark extends Sprite {

    public MarkTheShark(AbstractWorld world) {
        super("Mark_the_Shark_Animation.png", world, CategoryType.MARKTHESHARK, 320, 160, 1, 1);
    }
}
