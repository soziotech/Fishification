...
/**
 * Creates Christmas fish sprite.
 *
 * @author Martin Burkhard
 */
public class ChristmasFish extends Sprite {

    public ChristmasFish(AbstractWorld world) {
        super("Christmas_Fish_Animation.png", world, CategoryType.CHRISTMAS, 320, 160, 7, 7, true);
    }
}
