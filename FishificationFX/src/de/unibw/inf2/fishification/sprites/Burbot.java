...
/**
 * Creates Burbot fish sprite.
 *
 * @author Martin Burkhard
 */
class Burbot extends Sprite {

    public Burbot(AbstractWorld world) {
        super("Burbot_Animation.png", world, CategoryType.BURBOT, 320, 160, 1, 1);
    }
}
