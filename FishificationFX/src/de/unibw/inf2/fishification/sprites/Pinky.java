...
/**
 * Creates Pinky fish sprite.
 *
 * @author Martin Burkhard
 */
class Pinky extends Sprite {

    public Pinky(AbstractWorld world) {
        super("Pinky_Animation.png", world, CategoryType.PINKY, 320, 160, 7, 7, true);
    }
}
