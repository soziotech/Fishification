...
/**
 * Creates Twitter fish sprite.
 *
 * @author Martin Burkhard
 */
class TwitterFish extends Sprite {

    public TwitterFish(AbstractWorld world) {
        super("Twitter_Fish_Animation.png", world, CategoryType.TWITTER, 320, 160, 7, 7, true);
    }
}
