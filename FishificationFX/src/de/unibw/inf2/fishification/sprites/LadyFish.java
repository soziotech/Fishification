...
/**
 * Creates Lady fish sprite.
 *
 * @author Martin Burkhard
 */
class LadyFish extends Sprite {

    public LadyFish(AbstractWorld world) {
        super("Lady_Fish_Animation.png", world, CategoryType.LADY, 320, 160, 1, 1);
    }
}
