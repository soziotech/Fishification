...
/**
 * Defines the operations to be implemented by the FishWorld.
 *
 * @author Martin Burkhard
 */
@ThreadSafe
public interface IFishWorld {

    boolean addFishEntity(final FishEntity fishEntity);

    boolean feedFish(String source);
}
